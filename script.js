class Calculator {
  ...
  compute() {
    ...
    // switch statements are like if-else statements on a single item. We can use all of the cases(ifs) on a single item (this.operation)
    switch (this.operation) {
      ...
      case '÷':
        computation = prev / current;
        break;
      // default is the fallback if none of the cases run.
      default:
        return;
    }
